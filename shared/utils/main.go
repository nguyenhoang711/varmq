...
// Safe runs the provided function and returns any panic errors as an error.
...
// SafeGo runs the provided function in a goroutine and returns a channel that will receive any panic errors as an error.
